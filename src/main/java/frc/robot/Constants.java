 ...
 */
//location of motors is relative to the way the robot drives 
//refer to them as if you were sitting in the robot facing the front
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kTrackWidth = 0.5715;//22.5"
    // Distance between centers of right and left wheels on robot
    public static final double kWheelBase = 0.5715;//22.5"
  ...
  public static int kDriveWheelFreeSpeedRps;
  ...
  public static final class ModuleConstants {
    ...
    public static final int kEncoderCPR = 4096;//1024;was the original//CTRE Cancoder is 4096
